...
export function createEC2(stack: cdk.Stack, vpc: ec2.IVpc): ec2.Instance {
  ...
  instance.addUserData(
    ...
    'sudo curl -o /opt/minecraft/server/server.jar https://piston-data.mojang.com/v1/objects/e6ec2f64e6080b9b5d9b471b291c33cc7f509733/server.jar', // Download Minecraft server JAR
    ...
    '[{"uuid":"b0954e7e-edd9-4bb6-8eba-b7b25cd43210","name":"Igyigy97","level":4,"bypassesPlayerLimit":false},{"uuid":"80207481-a762-4066-bd76-8f50c3f21f1c","name":"bonirafa","level":2,"bypassesPlayerLimit":false}]', // Ops list
    'EOF',
    'sudo tee /opt/minecraft/server/usercache.json << EOF', // Create usercache.json file
    '[{"name":"Igyigy97","uuid":"b0954e7e-edd9-4bb6-8eba-b7b25cd43210","expiresOn":"2026-12-31 23:59:59 +0000"},{"name":"bonirafa","uuid":"80207481-a762-4066-bd76-8f50c3f21f1c","expiresOn":"2026-12-31 23:59:59 +0000"}]', // Usercache list
    'EOF',
